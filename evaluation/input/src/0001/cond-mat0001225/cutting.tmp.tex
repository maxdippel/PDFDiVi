...
\bibitem{Johansson} P. Johansson, R. Monreal and P. Apell, Phys. Rev. B{\bf 42}, 9210 (1990).
...
\begin{table}
\caption{Typical elasticity parameters Y (Young's modulus) and $\sigma_{Y}$ (yield stress) for different carbon materials\box3~ compared to steel. Due to the large anisotropy in the elastic constants of graphite we add those in parenthesis. They are relevant for the elastic strength and flexibility of the single wall nanotubes (SWNT).}
